function neededFiles = downloadBroadcastData(satsys,timeFrame,folderEph)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%        timeFrame - first and last moment you want to load data
%
%        timeFrame = [2017, 12, 30,    <- function handle year shifts
%                      2018,  1,  4];    
%
...
% Chceck upper limit of timeFrame
if mTime(end) > now()
...
for i = 1:length(filenames)
    ...
    downloadBroadcastMessage(satsys, mTime(i),folderEph);
end
